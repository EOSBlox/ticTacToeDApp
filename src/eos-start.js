...
class EosStart extends PolymerElement {
  static get template() {
    return html`
      ...
      <div class="container">
        ...
        <div class="middle">
          <div class="home-text">
            <div class="home-logo"><span>EOS</span>TICTACTOE</div>
            <div class="home-subtitle"><a href="#" target="_blank">View Contract</a></div>
          </div>
        </div>
        <div class="bottom">
...
} window.customElements.define('eos-start', EosStart);
